...
VALUES ("Felicita","Strøm",3, null),
       ("Ignat","Lauwens",2, 1),
       ("Sjakie","Stern",2, 1),
       ("Mus'ad","Ó Tuathail",1, 2),
       ("Tere","Munson",1, 3),
       ("Patrizia","Nyström",6, null),
       ("Heike","Crouch",5, 6),
       ("Darina","Curtis",5, 6),
       ("Tabitha","Štěpánek",4, 7),
       ("Fatima","Carl",4, 8),
       ("Aaron","Smolak",9, null),
       ...
       ("Mort","MacGilleChrìosd",12, null),
       ("Goodwin","Peterson",11, 16),
       ("Louane","Stasiuk",11, 16),
       ("Alina","Terrell",10, 17),
       ("Michael","Martínez",10, 18),
       ("Liùsaidh","Bellamy",15, null),
